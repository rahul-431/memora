...
export function SelectComp({
  ...
  return (
    <Select onValueChange={handleChange}>
      <SelectTrigger className="w-full max-w-44 sm:w-32 md:w-36 lg:w-40 xl:w-44 h-10 sm:h-[52px] border-[2px] border-[#F7AD3D] text-sm sm:text-base outline-none active:border-none">
